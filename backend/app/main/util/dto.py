...
class PaperDto:
    ...
    paper = api.model('paper', {
        'id': fields.Integer(required=True, description='paper id'),
...
class ReferenceDto:
    ...
    reference = api.model('reference', {
        'from_paper': fields.Integer(required=True, description='referencing paper'),
        'to_paper': fields.Integer(required=True, description='referenced paper'),
    })

class RelativeDto:
    api = Namespace('relative', description='relative related operations')
    relative = api.model('relative', {
        'id': fields.Integer(required=True, description='relative id'),
        ...
        'citations': fields.List(fields.Integer),
